...
@interface _TtC6WeChat46WSNativeHotListSettingHalfScreenViewController
{
    ...
    MISSING_TYPE *$__lazy_storage_$_itemViewCalculator;
    MISSING_TYPE *$__lazy_storage_$_customCloseButton;
    ...
    MISSING_TYPE *$__lazy_storage_$_spiltLineView;
}

- (id)initWithCoder:(id)arg1;
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;
@property(nonatomic) _Bool isHideCloseButton;
