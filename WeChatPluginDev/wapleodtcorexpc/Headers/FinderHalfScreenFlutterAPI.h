...
@interface FinderHalfScreenFlutterAPI : NSObject
{
...
- (void)onHalfScreenCancelWithCompletion:(CDUnknownBlockType)arg1;
- (void)onHalfScreenCancelModelUpdateCancelMode:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
