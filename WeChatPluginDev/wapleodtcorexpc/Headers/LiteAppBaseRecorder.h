...
@protocol LiteAppRecorderDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface LiteAppBaseRecorder : NSObject
{
    _Bool _isCheckEnvironment;
    _Bool _timerOnFire;
    struct LiteAppRecorderData *_aqData;
    ...
    id <LiteAppRecorderDelegate> _delegate;
    double _duration;
    double _startTime;
    double _recordTime;
...
@property(nonatomic) __weak id <LiteAppRecorderDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(retain, nonatomic) NSDictionary *settings; // @synthesize settings=_settings;
@property(retain, nonatomic) NSURL *url; // @synthesize url=_url;
@property(nonatomic) _Bool isCheckEnvironment; // @synthesize isCheckEnvironment=_isCheckEnvironment;
...
@property(nonatomic) struct LiteAppRecorderData *aqData; // @synthesize aqData=_aqData;
