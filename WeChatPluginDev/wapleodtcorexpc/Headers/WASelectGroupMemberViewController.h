...
@interface WASelectGroupMemberViewController
{
    _Bool _bIsAllSelect;
    _Bool _bIsSearching;
    id <WASelectGroupMemberControllerDelegate> _delegate;
    ...
    unsigned long long _maxSelectMember;
...
@property(nonatomic) unsigned long long maxSelectMember; // @synthesize maxSelectMember=_maxSelectMember;
...
@property(nonatomic) __weak id <WASelectGroupMemberControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)viewDidLoad;
- (id)initWithContact:(id)arg1 maxSelectMember:(unsigned long long)arg2;
