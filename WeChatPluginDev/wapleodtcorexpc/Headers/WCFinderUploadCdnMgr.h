...
@property(retain, nonatomic) NSString *taskWillReusePath; // @synthesize taskWillReusePath=_taskWillReusePath;
...
@property(retain, nonatomic) NSMutableSet *willReuseTaskMap; // @synthesize willReuseTaskMap=_willReuseTaskMap;
...
- (void)finderPreuploadCDNSuccess:(id)arg1;
...
- (_Bool)startUploadFinderCoverWithPostSession:(id)arg1 sucBlock:(CDUnknownBlockType)arg2 failBlock:(CDUnknownBlockType)arg3;
