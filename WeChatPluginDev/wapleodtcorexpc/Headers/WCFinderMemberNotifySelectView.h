...
{
    id <WCFinderMemberNotifySelectViewDelegate> _delegate;
    ...
    long long _selectTypeCount;
    long long _selectInitialIndex;
}
...
@property(nonatomic) __weak id <WCFinderMemberNotifySelectViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void)layoutSubviews;
