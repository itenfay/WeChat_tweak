...
@interface WCFinderMemberShipActivityViewModel : NSObject
{
    _Bool _isAuthor;
    id <WCFinderMemberShipActivityViewModelDelegate> _delegate;
    unsigned long long _unreadCount;
    unsigned long long _totalCount;
    NSString *_finderUsername;
    NSMutableArray *_displayPageModels;
    WCFinderMemberShipDiscussionPage *_currentPage;
...
@property(nonatomic) __weak id <WCFinderMemberShipActivityViewModelDelegate> delegate; // @synthesize delegate=_delegate;
