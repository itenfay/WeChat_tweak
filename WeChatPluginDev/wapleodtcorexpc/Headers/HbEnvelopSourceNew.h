...
@class HbEnvelopSourceNew_HbEnvelopSourceLocal, NSString;
...
@property(nonatomic) unsigned long long lastObtainTime; // @dynamic lastObtainTime;
@property(retain, nonatomic) NSString *materialId; // @dynamic materialId;
@property(retain, nonatomic) HbEnvelopSourceNew_HbEnvelopSourceLocal *sourceObject; // @dynamic sourceObject;
