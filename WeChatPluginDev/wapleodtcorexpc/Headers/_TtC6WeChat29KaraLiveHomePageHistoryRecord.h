...
@property(nonatomic) _Bool badgeAtOtherCell; // @synthesize badgeAtOtherCell;
@property(nonatomic) _Bool unreadAtOtherCell; // @synthesize unreadAtOtherCell;
