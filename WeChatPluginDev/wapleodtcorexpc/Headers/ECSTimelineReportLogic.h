...
@interface ECSTimelineReportLogic
{
    ...
    ECSTLTopBarReportItem *m_channelExposingItem;
    NSMutableArray *m_arrChannelExposedItem;
    NSMutableArray *m_arrChannelClickItem;
    ECSTLNotifyBarReportItem *m_notifyBarReportItem;
    ...
    id <ECSTimelineReportLogicDelegate> _delegate;
    ECSTLReportMainSessionInfo *_sessionInfo;
...
@property(retain, nonatomic) ECSTLReportMainSessionInfo *sessionInfo; // @synthesize sessionInfo=_sessionInfo;
@property(nonatomic) _Bool jump2OldBizList; // @synthesize jump2OldBizList=_jump2OldBizList;
@property(nonatomic) __weak id <ECSTimelineReportLogicDelegate> delegate; // @synthesize delegate=_delegate;
