...
@interface WCFinderMemberShipActivityViewController : NSObject
{
    WCFinderMemberShipActivityViewModel *_viewModel;
...
@property(retain, nonatomic) WCFinderMemberShipActivityViewModel *viewModel; // @synthesize viewModel=_viewModel;
...
- (void)onAddToMemberBlack:(id)arg1;
