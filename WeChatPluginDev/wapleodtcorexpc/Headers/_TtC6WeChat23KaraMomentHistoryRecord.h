...
@class KaraTextFeature_Embedding1x32, MISSING_TYPE, NSString, _TtC6WeChat17WCDBIntegerNumber;

@interface _TtC6WeChat23KaraMomentHistoryRecord : NSObject
{
    MISSING_TYPE *identifier;
    MISSING_TYPE *userName;
    MISSING_TYPE *isWeishang;
    MISSING_TYPE *cityOfPOI;
    MISSING_TYPE *feedWeishangType;
    MISSING_TYPE *sellerWeishangType;
    MISSING_TYPE *feedWeishangStatus;
    MISSING_TYPE *isTemplateFromMiaojian;
    MISSING_TYPE *textEmbedding1x32;
}
