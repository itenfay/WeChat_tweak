...
@class FinderJumpInfo_Style, MMTimer, MMUIButton, MMWebImageView, NSString, UILabel, WCFinderJumpInfo, WCFinderTextCarouselView;
@protocol WCFinderJumpInfoHardAdViewDelegate;

@interface WCFinderJumpInfoHardAdView : UIView
{
    int _showPosition;
