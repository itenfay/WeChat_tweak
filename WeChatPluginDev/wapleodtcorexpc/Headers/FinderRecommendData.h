...
@class FinderRecommendData_LiveItemInfo, NSString;
...
@property(nonatomic) unsigned int isRecommend; // @dynamic isRecommend;
@property(retain, nonatomic) FinderRecommendData_LiveItemInfo *liveInfo; // @dynamic liveInfo;
@property(nonatomic) unsigned int mappmsgid; // @dynamic mappmsgid;
@property(nonatomic) unsigned int mbizuin; // @dynamic mbizuin;
@property(nonatomic) unsigned int midx; // @dynamic midx;
