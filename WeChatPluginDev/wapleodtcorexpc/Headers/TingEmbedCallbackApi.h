...
- (void)onScrollViewDataCallbackOriginY30percent:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (void)onReloadPagePageType:(long long)arg1 completion:(CDUnknownBlockType)arg2;
