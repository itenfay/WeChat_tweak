...
@interface WCMomentsNewLifeShareManager : NSObject
{
    MyWCDB *_database;
}
...
- (_Bool)_validateMediaItemList:(id)arg1 inScene:(long long)arg2;
- (_Bool)_validateMediaItemList:(id)arg1;
- (_Bool)_validateDataItem:(id)arg1;
- (_Bool)_validateDevice;
- (_Bool)validateSharingWithDataItem:(id)arg1 inScene:(long long)arg2;
- (id)init;
