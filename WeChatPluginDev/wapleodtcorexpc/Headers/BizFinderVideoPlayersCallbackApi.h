...
@interface BizFinderVideoPlayersCallbackApi : NSObject
{
...
- (void)onVideoWaitingEndPlayerId:(long long)arg1 mediaId:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)onVideoWaitingPlayerId:(long long)arg1 mediaId:(id)arg2 isSeeking:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)onVideoPlayPlayerId:(long long)arg1 mediaId:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)onVideoPausePlayerId:(long long)arg1 mediaId:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)onVideoEndedPlayerId:(long long)arg1 mediaId:(id)arg2 completion:(CDUnknownBlockType)arg3;
