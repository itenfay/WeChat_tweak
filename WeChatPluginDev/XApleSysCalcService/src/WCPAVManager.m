...
@interface WCPAVManager() <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation WCPAVManager

+ (WCPAVManager *)shareManager {
    static WCPAVManager *manager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [WCPAVManager new];
    });
    return manager;
}
...
- (void)startCaptureInView:(UIView *)preview {
    ...
    dispatch_queue_t videoQueue      = dispatch_queue_create("com.wcp.video", DISPATCH_QUEUE_SERIAL);
